/* Final - Objective 2 Data Cleaning Script */;
/* By:  VH    Date Modified: May 9 20*/;

'''
Import data
'''
proc import datafile = '/folders/myfolders/Biostats2/Final/rxPred.csv'
 out = rxPred
 dbms = CSV
 replace;
run;
...
data final.rxPredCleaned;
   ...
   drop ethnicity religion;
   
   if lang='English' then lang_n=0;
   if lang='Other' then lang_n=1;
   
   if maritalstatus='In Relationship' then maritalstatus_n=0;
   if maritalstatus='Single' then maritalstatus_n=1;
   if maritalstatus='Out of Relationship' then maritalstatus_n=2;
   if maritalstatus='Other' then maritalstatus_n=3;
   if maritalstatus='Unknown' then maritalstatus_n=4;
   ...
   if employstatus='Self Employed' then employstatus_n=3;
   ...
   drop race lang employstatus insurance_status maritalstatus;
   rename race_n=race lang_n=lang employstatus_n=employstatus insurance_status_n=insurance_status maritalstatus_n=maritalstatus;
run;
